...
\subsubsection[{\texorpdfstring{loop(logger, frequence, supervision\+Time, arbre\+Precedent, dp, startinglevel)}{loop(logger, frequence, supervisionTime, arbrePrecedent, dp, startinglevel)}}]{\setlength{\rightskip}{0pt plus 5cm}def directory\+Supervisor.\+loop (
\begin{DoxyParamCaption}
\item[{}]{logger, }
\item[{}]{frequence, }
...
\item[{}]{startinglevel}
\end{DoxyParamCaption}
)}\hypertarget{namespacedirectory_supervisor_a97d1cb03388e91e814277fa2a7105f83}{}\label{namespacedirectory_supervisor_a97d1cb03388e91e814277fa2a7105f83}
